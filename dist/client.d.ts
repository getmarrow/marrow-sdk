...
export declare class MarrowClient {
    ...
    listResourceLeases(options?: {
        status?: 'active' | 'released' | 'expired';
        limit?: number;
    }): Promise<MarrowResourceLease[]>;
    acquireResourceLease(input: MarrowAcquireResourceLeaseInput): Promise<MarrowAcquireResourceLeaseResult>;
    releaseResourceLease(leaseId: string, leaseToken: string, agentId?: string | null): Promise<{
        released: true;
        lease: MarrowResourceLease | null;
    }>;
    listCoordinationProofPackets(limit?: number): Promise<MarrowCoordinationProofPacket[]>;
    createCoordinationProofPacket(input: MarrowCreateCoordinationProofPacketInput): Promise<MarrowCoordinationProofPacket>;
    compareReplayEvidence(input: MarrowReplayComparisonInput): Promise<MarrowReplayComparisonResult>;
    getReplayComparison(comparisonId: string): Promise<MarrowReplayComparisonResult>;
